...
import { Plus, Mail, UserCheck, UserX, Clock, XCircle, RefreshCw } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Gerencie usuários e convites da sua organização</p>
        </div>
